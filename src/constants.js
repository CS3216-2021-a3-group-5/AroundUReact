...
export const LOGIN_ROUTE = "/company/login";
export const REGISTER_ROUTE = "/company/registration";
export const USER_INFO = "/company/info";
export const UPDATE_USER_INFO = "/company/update";
